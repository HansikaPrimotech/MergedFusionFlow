...
const ChatExpandDialog = ({ show, dialogProps, onClear, onCancel, previews, setPreviews }) => {
    ...
    const component = show ? (
        <Dialog
            ...
            sx={{ overflow: 'visible' }}
        >
            {/* <DialogTitle sx={{ fontSize: '1rem' }} id='alert-dialog-title'> Changes by hansika */} 
            ...
            {/* changes by hansika <DialogContent sx={{ display: 'flex', justifyContent: 'flex-end', flexDirection: 'column' }}>
